...
## Corpus Check
- 73 files · ~39,227 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 6 file(s) not represented in the graph (top: (none) 4, .css 2)

## Summary
- 491 nodes · 662 edges · 46 communities (26 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb370b20`
...
9. `formatFlightTimeOnly()` - 8 edges
10. `resolveTransitAlertSummary()` - 8 edges
...
- `resolveTransitAlertSummary()` --calls--> `formatCtaAlertsSummary()`  [EXTRACTED]
  packages/core/src/maps.ts → packages/core/src/cta.ts
- `resolveTransitAlertSummary()` --calls--> `formatMtaAlertsSummary()`  [EXTRACTED]
  packages/core/src/maps.ts → packages/core/src/mta.ts
- `resolveTransitAlertSummary()` --calls--> `formatTflAlertsSummary()`  [EXTRACTED]
  packages/core/src/maps.ts → packages/core/src/tfl.ts
...
### Community 1 - "maps.ts"
Cohesion: 0.08
Nodes (33): AirportInfo, AIRPORTS, getAirportAddress(), CHICAGO_STATIONS, formatCtaAlertsSummary(), getCtaAlerts(), getCtaStationInfo(), isChicagoAirport() (+25 more)
...
Cohesion: 0.10
Nodes (19): dependencies, @aws-sdk/client-dynamodb, @aws-sdk/client-scheduler, @aws-sdk/lib-dynamodb, axios, date-fns, date-fns-tz, twilio (+11 more)
