...
## Corpus Check
- 76 files · ~39,129 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 6 file(s) not represented in the graph (top: (none) 4, .css 2)

## Summary
- 512 nodes · 709 edges · 46 communities (26 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `feca0cb3`
...
- `resolveTransitAlertSummary()` --calls--> `formatBartAlertsSummary()`  [EXTRACTED]
  packages/core/src/maps.ts → packages/core/src/bart.ts
...
### Community 2 - "trip.ts"
Cohesion: 0.11
Nodes (34): AirportInfo, AIRPORTS, getAirportAddress(), getAirportLabel(), getAirportTimezone(), calculateHoursUntilFlight(), calculateLeaveTime(), formatFlightDate() (+26 more)
...
## Knowledge Gaps
- **282 isolated node(s):** `name`, `private`, `workspaces`, `dev`, `deploy` (+277 more)
...
- **Why does `@aws-sdk/client-lambda` connect `cron.ts` to `functions/package.json`?**
