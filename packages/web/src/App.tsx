...
import Trips from './Trips'; // <--- Import the new component
...
function App() {
  ...
  return (
      <Authenticator socialProviders={['google']}>
        {({ signOut, user }) => (
            <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white p-6 flex flex-col items-center font-sans">

              <header className="w-full max-w-md flex justify-between items-center mb-8 pb-4 border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="flex gap-4 text-sm font-medium">
                  <button onClick={() => setView('list')} className={`${view === 'list' ? 'text-blue-600' : 'text-gray-500'}`}>My Trips</button>
                  <button onClick={signOut} className="text-gray-400 hover:text-red-500">Sign Out</button>
                </div>
              </header>
                    ...
                    step === 'input' ? (
                        <div className="animate-fade-in">
                          ...
                          <form onSubmit={handleLookup} className="space-y-4">
                            <div>
                              <label className="block text-xs uppercase tracking-wider text-gray-500 mb-1 font-semibold">Flight Info</label>
                            ...
                            <div>
                              <label className="block text-xs uppercase tracking-wider text-gray-500 mb-1 font-semibold">Start Location</label>
                              <input name="homeAddress" placeholder="123 Main St, Chicago..." required
                        ...
                        // --- CONFIRM VIEW ---
                        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl shadow-xl space-y-6 animate-fade-in border border-gray-100 dark:border-gray-700">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="p-4 bg-white dark:bg-gray-700/50 rounded-xl flex items-center gap-3">
